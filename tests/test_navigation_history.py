...
class NavigationHistoryTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.app.processEvents()  # 执行启动时默认进入炼金计算的 singleShot。
    ...
    def test_recipe_and_collection_subpages_are_restored(self) -> None:
        ...
        recipes._switch_saved_view("purchase_batches")
        recipes._switch_saved_view("json")

        self.window._navigate_back()
        self.assertEqual(recipes.navigation_subroute(), "purchase_batches")
        self.window._navigate_back()

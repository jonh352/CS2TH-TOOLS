...
re-login when the page shows a login prompt instead of a slider.
"""
    ...
    def complete_eco_access_gate(
        ...
        *,
        ...
        Returns:
            ...
            ``"no_slider"`` — short probe found neither slider/login clearance
        ...
        if progress:
            progress(
                "ECOSteam · 已打开窗口：请完成滑块验证，或按页面提示重新登录…"
            )
        page.goto(

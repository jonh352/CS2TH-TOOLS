...
"""Lean onedir build for CS2TH 汰换小助手 (best input for Inno LZMA Setup <100MB).

Avoid ``collect_all('PySide6')``. Keep Playwright driver for system Chrome/Edge.
"""
